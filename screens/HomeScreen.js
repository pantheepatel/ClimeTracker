...
import { MagnifyingGlassIcon, BellIcon, SunIcon, ArrowDownIcon, ArrowUpIcon, Cog6ToothIcon, Cog8ToothIcon } from 'react-native-heroicons/outline';
...
// &#176;c --> degree celsius
// TODO: add local time
// TODO: slider of sunset to sunrise goes to zero after 12:00 AM
export const colors = {
    black: '#22252d',
    white: '#fff',
    gray: '#636172',
            ...
            <Image source={require('../assets/images/bg_1.jpg')} style={[tw`absolute h-full w-full`, { absoluteFillObject: false }]} blurRadius={5} />
            {
                loading
                    ...
                    <View>
                        ...
                        <View style={[tw`px-5 mt-12 z-10 flex flex-row`, {}]}>
                            {/* search bar */}
                            <View style={tw`w-60`}>
                                {/* search input text */}
                            ...
                            <TouchableOpacity style={[tw`rounded-full py-3 px-1.5`, {}]}
                                onPress={() =>
                            ...
                            <TouchableOpacity style={[tw`rounded-full py-3 px-1.5`, {}]}
                                ...
                                <BellIcon style={tw`text-white`} size="29" color="white" />
                            </TouchableOpacity>
                        </View>
                        ...
                        <ScrollView vertical showsVerticalScrollIndicator={false} contentContainerStyle={[{}, tw`pt-2 pb-32`]}>
                            ...
                            <View style={[tw`content-around flex items-center`]}>
                                ...
                                <View style={tw`items-center`}>
                                    <Text style={[tw`text-5xl font-bold pt-2`, { color: colors.white }]}>
                                        {temp === 'Celsius (°C)' ? `${current?.temp_c}` : `${current?.temp_f}` + '°'}
                                    </Text>
                                            ...
                                            return (
                                                <View key={index} style={tw`flex items-center justify-center`}>
                                                    ...
                                                    <Text style={tw`text-white`}>
                                                        {temp === 'Celsius (°C)' ? `${item?.temp_c}` : `${item?.temp_f}` + '°'}
                                                    </Text>
                                                </View>
                                            )
                                        })
                                        ...
                                        return (
                                            <View key={index} style={tw`flex flex-row`}>
                                                ...
                                                <View style={tw`w-1/3 items-end justify-center`}>
                                                    <Text style={tw`text-white font-medium mt-0.5`}>
                                                        {temp === 'Celsius (°C)' ? `${item?.day?.avgtemp_c}C` : `${item?.day?.avgtemp_f}` + '°'}
                                                    </Text>
                                                </View>
                                            </View>
                                        )
                                                ...
                                                <Text style={[tw`text-lg text-white`]}>
                                                    {
                                                        item.name === "UV" ? current?.uv
                                                            : item.name === "Feels like" ? (temp === 'Celsius (°C)') ? current?.feelslike_c : current?.feelslike_f + '°'
                                                                : item.name === "Humidity" ? current?.humidity + '%'
                                                                    : item.name === "S wind" ? (wind === 'Kilometres per hour (km/h)') ? current?.wind_kph + ' km/h' : current?.wind_mph + ' mph'
                                                                        : item.name === "Air Pressure" ? (pressure === 'Millimetres (mm)') ? current?.pressure_mb + ' mb' : current?.pressure_in + ' in'
                                                                            : item.name === "Visibility" ? (visibility === 'Kilometres (kms)') ? current?.vis_km + ' km' : current?.vis_miles + ' miles'
                                                                                : null
                                                    }
                                                </Text>
                                            </View>
